...
export const decisionTreeData: Step[] = [
  ...
  // ═══════════════════════════════════════════
  // CONFORMITÉ : PARCOURS EN TEST
  // ═══════════════════════════════════════════
  {
    id: "3.test-en",
    dimension: "compliance",
    question: "Le cadre d'usage de l'IA en éducation (MEN, juin 2025) autorise cette exploration sous conditions strictes concernant les données.",
    choices: [
      { text: "J'ai compris les conditions, je continue mon évaluation", nextStep: "3.3" }
    ],
    infoTooltip: "Source : Cadre d'usage de l'IA en éducation, ministère de l'Éducation nationale, juin 2025.\n\nPage 10 : « Pour ses tâches pédagogiques (assistance à la préparation de cours, à l'évaluation, à la correction, etc.), tout enseignant peut utiliser des IA accessibles au grand public, sous sa responsabilité sachant que, comme toute donnée ou information utilisée à des fins d'enseignement, les productions générées par l'IA doivent être vérifiées et croisées avec d'autres sources. »\n\nPage 8 : « Le recours aux services d'IA accessibles au grand public est autorisé sous réserve qu'aucune donnée confidentielle ou à caractère personnel ne soit utilisée : ne peuvent ainsi être saisies dans de tels outils que des données qui peuvent être rendues publiques (notamment : textes et programmes officiels, ressources éducatives libres, données statistiques anonymisées, œuvres du domaine public). »\n\n⚠️ Si cet outil vous convient et que vous souhaitez en faire un usage régulier, il devra être inscrit au registre des traitements par votre responsable de traitement.",
  ...
  },
  {
    id: "3.eleves-test",
    dimension: "compliance",
    question: "Vous testez cet outil en vue d'une utilisation avec des élèves. Le cadre d'usage impose des conditions strictes.",
    choices: [
      { text: "J'ai compris les conditions, je continue mon évaluation", nextStep: "3.3" }
    ],
    infoTooltip: "Source : Cadre d'usage de l'IA en éducation, ministère de l'Éducation nationale, juin 2025.\n\nPage 8 : « Aucun membre du personnel ne doit demander aux élèves d'utiliser des services d'IA grand public impliquant la création d'un compte personnel. »\n\nPage 8 : « Le recours aux services d'IA accessibles au grand public est autorisé sous réserve qu'aucune donnée confidentielle ou à caractère personnel ne soit utilisée. »\n\nPage 9 : « L'utilisation pédagogique des IA génératives par les élèves, encadrée, expliquée et accompagnée par l'enseignant, est autorisée en classe à partir de la 4e en lien avec les objectifs des programmes scolaires et du CRCN. »\n\n⚠️ Pour un usage régulier avec des élèves, le service devra être inscrit au registre des traitements par le responsable de traitement (DASEN, chef d'établissement, recteur ou ministère).",
    infoSources: ["https://www.education.gouv.fr/sites/default/files/2025-06/l-ia-en-ducation---cadre-d-usage-440685.pdf"],
    pathways: ["students"]
  },

  // ═══════════════════════════════════════════
  // CONFORMITÉ : REGISTRE DES TRAITEMENTS (USAGE RÉGULIER)
  // ═══════════════════════════════════════════
  {
    id: "3.registre",
    dimension: "compliance",
    question: "Ce service est-il inscrit au registre des traitements de votre responsable de traitement ?",
    choices: [
      { text: "Oui, il est inscrit au registre", nextStep: "3.3", complianceLevel: "compliant" },
      { text: "Non, mais je vais demander son inscription", nextStep: "3.3", complianceLevel: "partial", warning: "Service non inscrit au registre des traitements — démarche d'inscription à engager auprès du responsable de traitement" },
      { text: "Non, et je ne compte pas le faire", nextStep: "reject", complianceLevel: "non-compliant", isEliminating: true, warning: "Un usage régulier nécessite l'inscription au registre des traitements par le responsable de traitement" },
      { text: "Je ne sais pas", nextStep: "3.registre.info" }
    ],
    infoTooltip: "L'évaluation de la conformité d'un traitement de données ne relève pas de l'enseignant ou de l'agent, mais du responsable de traitement.\n\nDans l'Éducation nationale, les responsables de traitement sont :\n• Le DASEN (1er degré)\n• Le chef d'établissement (2nd degré)\n• Le recteur (niveau académique)\n• Le ministère (services nationaux, accès via le GAR)\n\nSource : Cadre d'usage de l'IA en éducation, MEN, juin 2025, page 8 : « L'usage de l'IA se fait dans le respect du cadre légal sur la protection des données à caractère personnel (RGPD), en respectant notamment le principe de minimisation et l'accord du responsable de traitement. »",
    infoSources: ["https://www.education.gouv.fr/sites/default/files/2025-06/l-ia-en-ducation---cadre-d-usage-440685.pdf"],
    pathways: ["professional", "students"]
  },
  {
    id: "3.registre.info",
    dimension: "compliance",
    question: "Le registre des traitements recense tous les services traitant des données personnelles autorisés par votre institution. Renseignez-vous auprès de votre responsable de traitement ou de votre DPD (Délégué à la Protection des Données).",
    choices: [
      { text: "J'ai vérifié, je peux maintenant répondre", nextStep: "3.registre" }
    ],
    infoTooltip: "Pour savoir si un service est inscrit au registre :\n• 1er degré : contactez votre DASEN ou le DPD académique\n• 2nd degré : contactez votre chef d'établissement ou le DPD académique\n• Services nationaux : vérifiez si le service est accessible via le GAR (Gestionnaire d'Accès aux Ressources)\n\nLe DPD (Délégué à la Protection des Données) de votre académie peut vous renseigner.",
    isAction: true,
    pathways: ["professional", "students"]
  },
